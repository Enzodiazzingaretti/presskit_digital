...
(function i18n() {
  ...
  const translations = {
    en: {
      ...
      'bio.label':      'Biography',
      'bio.title':      'Biography.',
      'bio.p1':         "I'm a DJ and producer from Mendoza, Argentina. Born out of the pandemic in 2020, the project began as a personal exploration of electronic music alongside friends — a creative outlet that quickly evolved into a serious commitment to music.",
    ...
    es: {
      ...
      'bio.label':      'Biografía',
      'bio.title':      'Biografía.',
      'bio.p1':         'Soy un DJ y productor de Mendoza, Argentina. Nacido durante la pandemia en 2020, el proyecto comenzó como una exploración personal de la música electrónica junto a amigos — un espacio creativo que rápidamente se convirtió en un compromiso serio con la música.',
    ...
    pt: {
      ...
      'bio.label':      'Biografia',
      'bio.title':      'Biografia.',
      'bio.p1':         'Sou um DJ e produtor de Mendoza, Argentina. Nascido durante a pandemia em 2020, o projeto começou como uma exploração pessoal da música eletrônica com amigos — um espaço criativo que rapidamente se tornou um compromisso sério com a música.',
